...
public class ServerToolUpdateService {
    ...
    private static final List<ToolDefinition> TOOLS = List.of(
            ...
            goTool("assetfinder", "assetfinder", "assetfinder", "Reconocimiento", "Recoleccion rapida de dominios y subdominios relacionados.", "assetfinder --help", "github.com/tomnomnom/assetfinder"),
            aptTool("dnsenum", "dnsenum", "DNSEnum", "Reconocimiento", "Enumeracion DNS con fuerza bruta opcional de subdominios.", "dnsenum -h", "dnsenum"),
            pythonTool("dnsrecon", "dnsrecon", "DNSRecon", "Reconocimiento", "Registros DNS, AXFR, crt.sh, SRV y brute force controlado.", "dnsrecon -V"),
            aptTool("fierce", "fierce", "Fierce", "Reconocimiento", "Localizacion de subdominios y rangos relacionados por DNS.", "fierce --help", "fierce"),
            aptTool("fping", "fping", "fping", "Reconocimiento", "Ping sweep ligero para detectar hosts vivos.", "fping -v", "fping"),
